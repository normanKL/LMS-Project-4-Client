...
* You can also run it locally (requirement: have a local version of MongoDB running)
  ...
  <img src="https://github.com/user-attachments/assets/cab5e11f-9f6e-47ad-8440-ba8e09a2cd88" alt="image" height = "340" width="350" style="float: left; margin-right: 20px;" />
